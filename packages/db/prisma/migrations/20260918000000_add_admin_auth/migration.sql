-- CreateEnum
CREATE TYPE "AdminUserStatus" AS ENUM ('PENDING', 'APPROVED', 'DISABLED');
...
-- AddForeignKey
ALTER TABLE "admin_users" ADD CONSTRAINT "admin_users_approvedById_fkey" FOREIGN KEY ("approvedById") REFERENCES "admin_users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
